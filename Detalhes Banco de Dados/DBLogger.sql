...
-- -----------------------------------------------------
-- Table `mydb`.`Instalacoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Instalacoes` (
  ...
  CONSTRAINT `fk_Instalacoes_Loggers1`
    ...
    REFERENCES `mydb`.`Loggers` (`cdLogger`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Subprojetos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Subprojetos` (
  ...
  CONSTRAINT `fk_Subprojetos_Instalacoes1`
    ...
    REFERENCES `mydb`.`Instalacoes` (`cdInstal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Projetos` (
  ...
  CONSTRAINT `fk_Projetos_Subprojetos`
    ...
    REFERENCES `mydb`.`Subprojetos` (`cdSubprojeto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`InstalacoesSituacoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`InstalacoesSituacoes` (
